...
export const createModificationGroupSchema = z.object({
  modificationGroupName: z.string().min(1, { message: 'Заполните название группы' }),
...
export type CreateModificationGroupSchema = z.infer<typeof createModificationGroupSchema>;
