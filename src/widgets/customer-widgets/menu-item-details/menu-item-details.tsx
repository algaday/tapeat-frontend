...
import { updateMenuItem, useGetMenuItemQuery } from '@entities/menu-item/menu-item-description';
    ...
    return (
      <>
        <CustomerMenuItemOverview
          ...
          modificationsSlot={<DisplayModification modificationGroups={modificationGroups} />}
        />
      </>
    );
  }
